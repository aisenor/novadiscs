...
;define("novadiscs/components/stamps_form", ["exports", "@ember/component", "@ember/template-factory", "@ember/component/template-only"], function (_exports, _component, _templateFactory, _templateOnly) {
  ...
  function submit() {
    ...
    if (name.length == 0 || pdgaNumber.length == 0 || phoneNumber.length == 0 || email.length == 0){
        ...
        resp = "Dear Nova Discs Stamps,%0D%0A...%0D%0A" +
                "I would like to purchase a stamp with the following information%0D%0A...%0D%0A";
        for (const [key, value] of Object.entries(info)){
            resp = resp + "%0D%0A...%0D%0A" + key + ": " + value
        }
        window.location = "mailto:novadiscsstamps@gmail.com?subject=Custom Stamp Orders&body=" + resp
    }
  }
  </script>
