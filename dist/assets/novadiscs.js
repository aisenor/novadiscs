  ...
  <table class="puttingleaguescoresheet">
    ...
    <tbody>
        ...
        <tr>
          ...
          <td id="checkAll10" class="checkAll" onclick="checkAll(10)">Check<br>All</td>
          <td id="checkAll15" class="checkAll" onclick="checkAll(15)">Check<br>All</td>
          <td id="checkAll20" class="checkAll" onclick="checkAll(20)">Check<br>All</td>
          <td id="checkAll25" class="checkAll" onclick="checkAll(25)">Check<br>All</td>
          <td id="checkAll30" class="checkAll" onclick="checkAll(30)">Check<br>All</td>
        </tr>
    </tbody>
